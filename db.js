...
const connectToMongo = ()=>{
    mongoose.connect(process.env.DB_URI || "mongodb+srv://apple:apple123@cluster0.gqruk.mongodb.net/?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true })
